// Code generated by protoc-gen_go-go-grpc. DO NOT EDIT.
// versions:
// - protoc-gen_go-go-grpc v1.5.1
// - protoc             v5.28.2
...
func NewBertServiceClient(cc grpc.ClientConnInterface) BertServiceClient {
...
// BertServiceServer is the server API for BertService service.
...
// UnimplementedBertServiceServer must be embedded to have
...
// UnsafeBertServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to BertServiceServer will
// result in compilation errors.
type UnsafeBertServiceServer interface {
	mustEmbedUnimplementedBertServiceServer()
}

func RegisterBertServiceServer(s grpc.ServiceRegistrar, srv BertServiceServer) {
	// If the following call pancis, it indicates UnimplementedBertServiceServer was
...
// BertService_ServiceDesc is the grpc.ServiceDesc for BertService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var BertService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "model.BertService",
